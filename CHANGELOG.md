...
- SCOPE-XR is now available on PyPI! Install with `pip install scopexr`.

- Added automated test workflow (`test.yaml`) that runs pytest on all commits and pull requests.
